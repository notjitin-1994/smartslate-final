...
// 1. Add Meteors and ShineBorder imports
if (!content.includes("import { Meteors }")) {
...
"                      <div className=\"mb-6 inline-flex items-center rounded-full bg-[#a7dadb]/10 border border-[#a7dadb]/20 px-4 py-1.5 text-xs font-bold tracking-[0.2em] text-[#a7dadb] uppercase\">\n" +
"                        TRANSFORM WITH SMARTSLATE\n" +
"                      </div>\n" +
"                      \n" +
"                      <h2 className=\"mb-6 font-heading text-4xl font-extrabold leading-[1.1] text-white md:text-5xl lg:text-6xl text-left\">\n" +
"                        Ready to Transform <br />\n" +
"                        <span className=\"text-[#a7dadb]\">Learning Forever?</span>\n" +
"                      </h2>\n" +
"                      \n" +
"                      <p className=\"mb-10 max-w-2xl text-lg leading-relaxed text-[#b0c5c6] md:text-xl text-left\">\n" +
"                        Experience the world's most advanced AI-native learning ecosystem. \n" +
"                        From intelligent blueprinting to adaptive delivery, Smartslate handles the complexity \n" +
"                        so that you can focus on driving real business impact.\n" +
"                      </p>\n" +
"                      \n" +
...
"                          desc: \"Full access to Polaris—no trials, no limits.\"\n" +
"                        },\n" +
"                        {\n" +
"                          icon: <Speed className=\"h-6 w-6 text-[#a7dadb]\" />,\n" +
"                          title: \"Instant Activation\",\n" +
"                          desc: \"Sign up and start creating architectures immediately.\"\n" +
"                        },\n" +
"                        {\n" +
"                          icon: <WorkspacePremium className=\"h-6 w-6 text-[#a7dadb]\" />,\n" +
"                          title: \"Premium Features Included\",\n" +
"                          desc: \"Access powerful enterprise tools from day one.\"\n" +
"                        }\n" +
"                      ].map((item, i) => (\n" +
...
"              \n" +
"              {/* Radial Glow */}\n" +
"              <div className=\"absolute -bottom-24 -right-24 h-96 w-96 rounded-full bg-[#4F46E5]/20 blur-[120px] pointer-events-none\" />\n" +
"            </div>\n" +
"          </MotionBox>\n" +
"        </Container>\n" +
"      </Box>\n" +
...
"      {";
  ...
  console.log('Successfully updated final CTA section in page.tsx');
} else {
