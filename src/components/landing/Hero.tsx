  ...
  return (
    <>
      <StandardHero
        ...
        description="The future of business is being written in India, yet a silent crisis threatens to derail it all. Thousands or more of ambitious individuals are entering the workforce, but they lack the specific, critical skills your company needs to innovate and compete."
