...
// Removed next-themes useTheme as we are forcing dark theme logic
...
export function MagicCard(props: MagicCardProps) {
  ...
  const isDarkTheme = true // Force dark theme blend mode
  ...
  return (
    <motion.div
      ...
      style={{
        background: useMotionTemplate`
          linear-gradient(#0d1b2a 0 0) padding-box,
    ...
    >
      <div className="absolute inset-px z-20 rounded-[inherit] bg-[#0d1b2a]" />
