  ...
  return (
    <PageWrapper>
      ...
      {products.map((product, index) => (
        <SectionWrapper key={product.heading}>
          <Container maxWidth="lg">
            <ProductSection
              product={product}
              reverse={product.reverse}
            >
              {product.heading === 'Ignite Series' && <IgniteInfographic />}
              {product.heading === 'Strategic Skills Architecture' && <StrategicSkillsInfographic />}
              {product.heading === 'Solara' && <SolaraInfographic />}
            </ProductSection>
          </Container>
        </SectionWrapper>
      ))}
