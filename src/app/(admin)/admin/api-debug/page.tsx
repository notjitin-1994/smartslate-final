...
export default function AdminApiDebugPage() {
  ...
  const apiEndpoints: ApiEndpoint[] = [
    // Admin APIs
    {
      ...
      method: 'GET',
      description: 'Fetch all leads across different categories',
      requiresAuth: true,
    ...
    },
    {
      ...
      method: 'POST',
      description: 'Seed or sync system roles',
      requiresAuth: true,
    ...
    },
    {
      path: '/api/auth/roles',
      method: 'POST',
      description: 'Ensure default roles for current user',
      requiresAuth: true,
      permissions: []
    },
    {
    ...
    // Lead APIs
    {
      path: '/api/leads/course-waitlist',
      method: 'POST',
      description: 'Submit course waitlist lead',
      requiresAuth: false,
      samplePayload: {
        name: 'John Doe',
        ...
        role: 'Manager',
        courseId: 'course-id',
        preferredStartDate: 'Q1 2024',
        additionalInfo: 'Additional information'
      }
    },
    {
      path: '/api/leads/solara',
      method: 'POST',
      description: 'Submit Solara interest lead',
      requiresAuth: false,
      samplePayload: {
        name: 'Jane Smith',
        ...
        role: 'CTO',
        companySize: '50-100',
        primaryInterest: 'AI Implementation',
